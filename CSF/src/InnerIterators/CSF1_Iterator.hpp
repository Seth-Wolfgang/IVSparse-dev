...
namespace CSF {
     ...
     * The CSF1 Inner Iterator is a forward traversal iterator like the others in the 
     * CSF library. It's very low overhead and is used to traverse over the nonzeros
     * of a single vector of a matrix or a vector on its own.
     */
    ...
    class SparseMatrix<T, indexT, 1, columnMajor>::InnerIterator {
        ...
        */
        ...
        /**
         * CSF1 Matrix InnerIterator Constructor \n \n
        ...
        /**
         * CSF1 Vector InnerIterator Constructor \n \n
         ...
         * 
         * @warning This method may break things if used without care, CSF is not meant
         * to update values.
         */
