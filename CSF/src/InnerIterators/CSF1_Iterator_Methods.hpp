/**
 * @file CSF1_Iterator_Methods.hpp
 * @author Skyler Ruiter and Seth Wolfgang
 * @brief Iterator Methods for CSF1 Sparse Matrices
 * @version 0.1
 * @date 2023-07-03
 */
