...
namespace CSF {
     ...
     * 
     * CSF3 Inner Iterator Class \n \n
     * The CSF3 Inner Iterator is a forward traversal iterator like the others in the
     * CSF library. The CSF3 Iterator is slower than the others due to needing to decode
     * compressed data. 
     */
    ...
    class SparseMatrix<T, indexT, compressionLevel, columnMajor>::InnerIterator {
        ...
        */
        ...
        /**
         * CSF3 Matrix InnerIterator Constructor \n \n
        ...
        /**
         * CSF3 Vector InnerIterator Constructor \n \n
