 ...
 * @brief CSF3 Vector Class Declerations
 * @version 0.1
 * @date 2023-07-03
 */
...
namespace CSF {
     ...
     * 
     * CSF3 Vector Class \n \n
     * The CSF3 Vector class is a vector class that is used to work with
     * CSF3 matrices. It works with the same logic as the corresponding
    ...
    class SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector {
        ...
        */
         ...
         * Creates a vector from a CSF3 Matrix at the given vector index.
         *
        ...
        // equality operator
        bool operator==(typename SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector &vec);
