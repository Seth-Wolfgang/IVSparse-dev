...
namespace CSF
{
    ...
    class SparseMatrix
    {
        ...
        // Calculate the Compression Size of the CSF Matrix in bytes
        ...
        inline Eigen::Matrix<T, -1, -1> vectorMultiply(Eigen::VectorXi &vec);
         ...
         * @param other The CSF matrix to convert
         *
        ...
        */
        ...
        Eigen::VectorXi operator*(Eigen::VectorXi &vec);
        Eigen::VectorXi operator*(typename SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector &vec);
