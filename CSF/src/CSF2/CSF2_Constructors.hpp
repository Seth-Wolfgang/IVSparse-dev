...
namespace CSF {
    ...
    template <typename T, typename indexT, bool columnMajor>
    SparseMatrix<T, indexT, 2, columnMajor>::SparseMatrix(const CSF::SparseMatrix<T, indexT, 2, columnMajor> &other) { *this = other; }

    // Conversion Constructor
    template <typename T, typename indexT, bool columnMajor>
    template <uint8_t otherCompressionLevel>
    SparseMatrix<T, indexT, 2, columnMajor>::SparseMatrix(CSF::SparseMatrix<T, indexT, otherCompressionLevel, columnMajor> &other) {
        ...
        CSF::SparseMatrix<T, indexT, 2, columnMajor> temp;
