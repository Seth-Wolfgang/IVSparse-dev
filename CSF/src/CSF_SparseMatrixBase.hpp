 ...
 * @brief CSF Sparse Matrix Base Class Declerations
 * @version 0.1
 * @date 2023-07-03
 */
...
namespace CSF {
    ...
    /**
     * CSF Sparse Matrix Base Class \n \n
     * This is the overarching base class for the CSF Sparse Matrix
     * Library. It contains methods and variables shared between all
     * compression levels of CSF Sparse Matrices and serves to reduce
     * code duplication.
     */
