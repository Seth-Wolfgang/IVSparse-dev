...
p <- ggplot(combined_data, aes(x = sparsity, y = ratio, color = dataset, shape = dataset)) +
    geom_point() +
    labs(x = "Sparsity",
...
triple_plot_ratio_over_eigen(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"sum_time","All_10_density")
...
density_triple_size_plot(density_IVCSCResults10, "IVCSC",  density_VCSCResults10, "VCSC", density_eigenResults10, "CSC" , density_eigenResults10, density_eigenResults10, density_eigenResults10 ,"All_10_redundancy")
