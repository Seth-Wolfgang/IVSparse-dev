...
sizeData <- read.csv("sizeData100x100.csv")
...
sizeData$Ratio <- sizeData$CSF3.Size / sizeData$CSF1.Size
...
realSizeData$Ratio <- realSizeData$CSF3.Size / realSizeData$CSF1.Size

# Add markers from another dataset
surfacePlot <- surfacePlot %>%
  add_markers(data = realSizeData, x = ~Redundancy, y = ~Sparsity, z = ~Ratio)

# Configure the layout for the 3D plot
surfacePlot <- surfacePlot %>%
  layout(scene = list(xaxis = list(title = "Redundancy"),
                      yaxis = list(title = "Sparsity"),
                      zaxis = list(title = "CSF3.Size / CSF1.Size")))

# Display the updated 3D plot with surface and markers
surfacePlot
