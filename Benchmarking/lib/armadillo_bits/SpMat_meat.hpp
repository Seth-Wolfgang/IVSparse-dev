...
SpMat<eT>::is_finite() const
  ...
  arma_extra_debug_sigprint();
    ...
    {
    arma_debug_warn_level(2, "is_finite(): cannot detect non-finite values in fast math mode");
    }
  #endif
...
SpMat<eT>::has_inf() const
  ...
  #if defined(__FAST_MATH__)
    {
    arma_debug_warn_level(2, "has_inf(): cannot detect non-finite values in fast math mode");
    }
  #endif
...
SpMat<eT>::has_nan() const
  ...
  #if defined(__FAST_MATH__)
    {
    arma_debug_warn_level(2, "has_nan(): cannot detect non-finite values in fast math mode");
    }
  #endif
...
SpMat<eT>::has_nonfinite() const
  ...
  #if defined(__FAST_MATH__)
    {
    arma_debug_warn_level(2, "has_nonfinite(): cannot detect non-finite values in fast math mode");
    }
  #endif
