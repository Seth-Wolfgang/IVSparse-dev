...
op_find_finite::apply(Mat<uword>& out, const mtOp<uword, T1, op_find_finite>& X)
  ...
  arma_extra_debug_sigprint();
    ...
    {
    arma_debug_warn_level(2, "find_finite(): cannot detect non-finite values in fast math mode");
    }
  #endif
...
op_find_nonfinite::apply(Mat<uword>& out, const mtOp<uword, T1, op_find_nonfinite>& X)
  ...
  #if defined(__FAST_MATH__)
    {
    arma_debug_warn_level(2, "find_nonfinite(): cannot detect non-finite values in fast math mode");
    }
  #endif
...
op_find_nan::apply(Mat<uword>& out, const mtOp<uword, T1, op_find_nan>& X)
  ...
  #if defined(__FAST_MATH__)
    {
    arma_debug_warn_level(2, "find_nan(): cannot detect non-finite values in fast math mode");
    }
  #endif
