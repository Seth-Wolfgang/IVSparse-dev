...
public:
    ...
    DeBruinesComp(const vector<unsigned int> &vals)
    {
        ...
        // * Print Vector up until this point
        cout << "Vector up to col_ptr: " << endl;
        ...
        for (int i = 0; i < num_cols; i++)
        {
            ...
            for (size_t k = 0; k < unique_vals.size(); k++)
            {
                ...
                // Find each indicie of the unique value and push to a temp vector
