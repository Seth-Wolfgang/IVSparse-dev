...
namespace IVSparse {
     ...
     * basic version of the IVSparse format. Mostly used for ease of use with other compression
    ...
    class SparseMatrix<T, indexT, 1, columnMajor> : public SparseMatrixBase {
        ...
        inline IVSparse::SparseMatrix<T, indexT, 1, columnMajor> scalarMultiply(T scalar);
         ...
         *
         * @attention This constructor is not recommended for use as updating a IVSparse matrix is not well supported.
         */
        SparseMatrix(){};
        ...
        /**
         * @tparam compressionLevel2 The compression level of the IVSparse matrix to convert
         ...
         * This constructor takes in a IVSparse matrix of the same storage order, value, and index type and converts it to
        ...
        /**
         * Raw CSC Constructor \n \n
         * This constructor takes in raw CSC storage format pointers and converts it to a IVSparse matrix.
         * One could also take this information and convert to an Eigen Sparse Matrix and then to a IVSparse matrix.
         */
         ...
         */
        typename IVSparse::SparseMatrix<T, indexT, 1, columnMajor>::Vector getVector(uint32_t vec);
        ...
        /**
         * @returns A vector of IVSparse vectors that represent a slice of the IVSparse matrix.
         */
        ...
        // Assignment Operator
        IVSparse::SparseMatrix<T, indexT, 1, columnMajor> &operator=(const IVSparse::SparseMatrix<T, indexT, 1, columnMajor> &other);
        ...
        typename IVSparse::SparseMatrix<T, indexT, 1, columnMajor>::Vector operator[](uint32_t vec);
