...
namespace IVSparse {
    ...
    SparseMatrix<T, indexT, 1, columnMajor> &SparseMatrix<T, indexT, 1, columnMajor>::operator=(const IVSparse::SparseMatrix<T, indexT, 1, columnMajor> &other) {
    ...
    typename SparseMatrix<T, indexT, 1, columnMajor>::Vector SparseMatrix<T, indexT, 1, columnMajor>::operator[](uint32_t vec) {
        ...
        typename IVSparse::SparseMatrix<T, indexT, 1, columnMajor>::Vector newVector(*this, vec);
        return newVector;
    }
    ...
    template <typename T, typename indexT, bool columnMajor>
    IVSparse::SparseMatrix<T, indexT, 1, columnMajor> SparseMatrix<T, indexT, 1, columnMajor>::operator*(T scalar) {
