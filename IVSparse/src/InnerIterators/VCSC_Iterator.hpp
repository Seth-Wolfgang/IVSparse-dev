...
namespace IVSparse {
     ...
     * The VCSC Inner Iterator is a forward traversal iterator like the others in the
     * IVSparse library. It's very low overhead and is used to traverse over the nonzeros
     * of a single vector of a matrix or a vector on its own. The VCSC Inner Iterator
     * differs from the CSC Iterator in that it travereses a counts vector in the
