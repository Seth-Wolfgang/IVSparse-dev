...
namespace IVSparse {
     ...
     * The IVCSC Inner Iterator is a forward traversal iterator like the others in the
     * IVSparse library. The IVCSC Iterator is slower than the others due to needing to decode
     * compressed data.
     */
