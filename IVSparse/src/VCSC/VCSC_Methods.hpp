...
namespace IVSparse
{
    ...
    template <typename T, typename indexT, bool columnMajor>
    typename IVSparse::SparseMatrix<T, indexT, 2, columnMajor>::Vector SparseMatrix<T, indexT, 2, columnMajor>::getVector(uint32_t vec) { return (*this)[vec]; }
    ...
    void SparseMatrix<T, indexT, 2, columnMajor>::inPlaceTranspose()
    {
        ...
        *this = IVSparse::SparseMatrix<T, indexT, 2, columnMajor>(mapsT, numRows, numCols);
    }
