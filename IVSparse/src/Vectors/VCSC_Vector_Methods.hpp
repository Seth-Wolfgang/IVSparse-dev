...
namespace IVSparse
{
    ...
    template <typename T, typename indexT, bool columnMajor>
    SparseMatrix<T, indexT, 2, columnMajor>::Vector::Vector(IVSparse::SparseMatrix<T, indexT, 2, columnMajor>::Vector &vec)
    {
...
#pragma omp parallel for schedule(dynamic)
    ...
    template <typename T, typename indexT, bool columnMajor>
    typename IVSparse::SparseMatrix<T, indexT, 2, columnMajor>::Vector SparseMatrix<T, indexT, 2, columnMajor>::Vector::operator*(T scalar)
    {
