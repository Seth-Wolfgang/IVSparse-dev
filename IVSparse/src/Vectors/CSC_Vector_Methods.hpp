...
namespace IVSparse
{
    ...
    template <typename T, typename indexT, bool columnMajor>
    SparseMatrix<T, indexT, 1, columnMajor>::Vector::Vector(IVSparse::SparseMatrix<T, indexT, 1, columnMajor> &mat, uint32_t vec)
    {
    ...
    template <typename T, typename indexT, bool columnMajor>
    SparseMatrix<T, indexT, 1, columnMajor>::Vector::Vector(IVSparse::SparseMatrix<T, indexT, 1, columnMajor>::Vector &vec)
    {
        length = vec.length;
        nnz = vec.nnz;
        size = vec.size;
