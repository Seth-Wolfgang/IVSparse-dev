...
namespace IVSparse
{
    ...
    // Length Constructor
    template <typename T, typename indexT, uint8_t compressionLevel, bool columnMajor>
    SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector::Vector(uint32_t length) { this->length = length; }
    ...
    template <typename T, typename indexT, uint8_t compressionLevel, bool columnMajor>
    SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector::Vector(IVSparse::SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector &vec)
    {
        // set the size
        size = vec.size;
    ...
    // equality operator
    template <typename T, typename indexT, uint8_t compressionLevel, bool columnMajor>
    bool SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector::operator==(typename SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector &other)
    {
    ...
    template <typename T, typename indexT, uint8_t compressionLevel, bool columnMajor>
    typename IVSparse::SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector SparseMatrix<T, indexT, compressionLevel, columnMajor>::Vector::operator*(T scalar)
    {
